...
$home_admin_proc_url = $admin_url."/proc";
$home_admin_proc_path = $admin_path."/proc";


$mng_path = $home_path."/mng";
$mng_url = $home_url."/mng";
$mng_css_url = $mng_url."/css";
$mng_js_url = $mng_url."/js";
$mng_ic_page_path = $mng_path."/ic_page";
$mng_ic_page_include_path = $mng_path."/ic_page/include";

$home_mng_proc_url = $mng_url."/proc";
$home_mng_proc_path = $mng_path."/proc";


$chat_path = $home_path."/chat";
$chat_url = $home_url."/chat";
$chat_css_url = $chat_url."/css";
$chat_js_url = $chat_url."/js";
$chat_ic_page_path = $chat_path."/ic_page";
$chat_ic_page_include_path = $chat_path."/ic_page/include";

$home_chat_proc_url = $chat_url."/proc";
$home_chat_proc_path = $chat_path."/proc";
...
$img_upload_ext = "gif,GIF,jpg,JPG,jpeg,JPEG,png,PNG,mp3,MP3,mp4,MP4,avi,AVI,wmv,WMV,fla,FLA";
