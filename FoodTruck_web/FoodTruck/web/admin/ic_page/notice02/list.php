...
$count_que = "select count(key_index) from ".$TBA['JY_NOTICE']." Where type = 1 and (1) $que_where $que_where02";
//echo $count_que;
...
$list_que = "select * from ".$TBA['JY_NOTICE']." where type = 1 and (1) $que_where $que_where02 order by key_index desc limit $page_start,$scale";
