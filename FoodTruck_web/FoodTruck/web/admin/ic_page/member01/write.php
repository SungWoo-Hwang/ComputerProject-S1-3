...
<div class="">
	<div class="alignr">
		<a href="javascript:;" class="btn list" onclick="confirm_pop('탈퇴 처리','aboat', '<?=$home_admin_proc_url?>/<?=$proc_url?>');" >
			<span>탈퇴처리</span>
		</a>
		<a href="javascript:;" class="btn list" onclick="confirm_pop('블랙리스트','blacklist', '<?=$home_admin_proc_url?>/<?=$proc_url2?>');" >
			<span>블랙리스트추가</span>
		</a>
	</div>
</div>
...
<div class="table_area margint10">
	...
	<table class="write margint10">
		...
		<tr>
			...
			<td colspan="3">
				<input type="text" name="mb_id" value="<?=$row['mb_id']?>" class="in_wp300" readonly placeholder="핸드폰번호" />
			</td>
		</tr>
		<tr>
			<th scope="row">
		...
		<tr>
			...
			<td colspan="3">
				<input type="text" name="mb_name" value="<?=$row['mb_name']?>" class="in_wp300" placeholder="핸드폰번호" />
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3">
				<textarea name="blacklist_comment" rows="" cols="" class="in_w100"><?=$row['blacklist_comment']?></textarea>
			</td>
		</tr>
