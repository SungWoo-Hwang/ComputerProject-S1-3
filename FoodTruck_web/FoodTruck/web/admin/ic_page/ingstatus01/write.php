...
<form method="post" action="<?=$home_admin_proc_url?>/product_write.php" name="board_form" onsubmit="return board_func();" enctype="multipart/form-data">
	...
	<input type="hidden" name="pt" value="view">
	...
	<div class="table_area margint10">
		<table class="write margint10">
			...
			<tr>
				...
				<td>
					<input type="file" name="list_file" class="in_w100" id="input_titlelink" />
					<p class="margint5"><input type="checkbox" name="list_file_del" value="1" id="list_file_del"> <label for="list_file_del">삭제</label></p>
					<?if($w == "u" && $row['list_file'] != ""){?>
				...
				<td>
					...
					<tr>
						<td style="border-bottom: none;">
							...
							<p class="margint5"><input type="checkbox" name="img_file01_del" value="1" id="img_file01_del"> <label for="img_file01_del">삭제</label></p>
						...
						<td style="border-bottom: none;">
							...
							<p class="margint5"><input type="checkbox" name="img_file02_del" value="1" id="img_file02_del"> <label for="img_file02_del">삭제</label></p>
							<?if($w == "u" && $row['img_file02'] != ""){?>
								<img src="<?=$row['img_file02']?>" onerror="this.src='./images/common/no_img.png'" width="200" class="margint10">
							<?}?>	
						</td>
						<td style="border-bottom: none;">
							<input type="file" name="img_file03" class="in_w100" id="input_titlelink" />
							<p class="margint5"><input type="checkbox" name="img_file03_del" value="1" id="img_file03_del"> <label for="img_file03_del">삭제</label></p>
							<?if($w == "u" && $row['img_file03'] != ""){?>
								<img src="<?=$row['img_file03']?>" onerror="this.src='./images/common/no_img.png'" width="200" class="margint10">
							<?}?>	
						</td>
						<td style="border-bottom: none;">
							<input type="file" name="img_file04" class="in_w100" id="input_titlelink" />
							<p class="margint5"><input type="checkbox" name="img_file04_del" value="1" id="img_file04_del"> <label for="img_file04_del">삭제</label></p>
							<?if($w == "u" && $row['img_file04'] != ""){?>
								<img src="<?=$row['img_file04']?>" onerror="this.src='./images/common/no_img.png'" width="200" class="margint10">
							<?}?>	
						</td>
						<td style="border-bottom: none;">
							<input type="file" name="img_file05" class="in_w100" id="input_titlelink" />
							<p class="margint5"><input type="checkbox" name="img_file05_del" value="1" id="img_file05_del"> <label for="img_file05_del">삭제</label></p>
							<?if($w == "u" && $row['img_file05'] != ""){?>
