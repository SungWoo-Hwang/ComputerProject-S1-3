...
$count_que = "select count(key_index) from ".$TBA['JY_MEMBER']." Where (1) $que_where $que_where02 and ing_status = 1 and login_type = 1";
//echo $count_que;
...
$list_que = "select * from ".$TBA['JY_MEMBER']." where (1) $que_where $que_where02 and ing_status = 1 and login_type = 1 order by key_index desc limit $page_start,$scale";
