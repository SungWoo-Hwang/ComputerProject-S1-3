...
<html lang="ko">
	...
	<body onload="sample2_execDaumPostcode()">
		...
		<div id="layer" style="display:none;position:fixed;overflow:hidden;z-index:1;-webkit-overflow-scrolling:touch; width: 100%; height: 100%;">
		...
		<script>
			...
			function closeDaumPostcode() {
				...
				window.location.href = "js2ios://SetNativeAddr?param1=" + "" + "&param2=" + "" + "&ReturnFun=null";
			...
			function sample2_execDaumPostcode() {
				new daum.Postcode({
					oncomplete: function(data) {
						...
						//alert(addr);
						window.location.href = "js2ios://SetNativeAddr?param1=" + data.zonecode + "&param2=" + data.roadAddress + "&ReturnFun=" + data.jibunAddress;
// 						window.location.href = "js2ios://SetNativeAddr?param1=" + data.zonecode + "&param2=" + data.jibunAddress;
						//alert(data.zonecode);
						// iframe을 넣은 element를 안보이게 한다.
			...
			function initLayerPosition(){
				...
				element_layer.style.width = 'calc(100% - 10px)';
				element_layer.style.height = 'calc(100% - 10px)';
