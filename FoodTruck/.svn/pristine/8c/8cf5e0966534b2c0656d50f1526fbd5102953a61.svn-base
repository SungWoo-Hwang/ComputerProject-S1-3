...
//		setGlobalFont(getWindow().getDecorView());
	...
	public void customProgressPop(){
		Log.e("SKY" , "--customProgressPop--");
		try{
			Log.e("SKY" , "--customProgressPop1--");
			if (customDialog==null){
				Log.e("SKY" , "--customProgressPop2--");
				...
				customDialog.setMessage("전송중입니다..");
				customDialog.setCancelable(false);
				customDialog.show();
				Log.e("SKY" , "--customProgressPop3--");
			}
		}catch(Exception ex){
			Log.e("SKY" , "--customProgressPop5--");
		}
	}
